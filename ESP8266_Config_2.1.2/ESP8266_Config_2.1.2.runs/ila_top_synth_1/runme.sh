...
HD_PWD='D:/Vivado_Program_Files/20170711_ESP8266/ESP8266_Config_2.1.2/ESP8266_Config_2.1.2.runs/ila_top_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ila_top.tcl
