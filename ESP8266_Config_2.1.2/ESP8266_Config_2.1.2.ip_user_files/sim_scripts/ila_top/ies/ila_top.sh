...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../ESP8266_Config_2.1.2.srcs/sources_1/ip/ila_top/sim/ila_top.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.ila_top $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.ila_top -input simulate.do
}
# Script usage
usage()
{
