...
HD_PWD='D:/Vivado_Program_Files/20170711_ESP8266/ESP8266_Config_2.1/ESP8266_Config_2.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ESP8266_Config.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ESP8266_Config.tcl
