...
HD_PWD='D:/Vivado_Program_Files/20170711_ESP8266/ESP8266_Config_2.1/ESP8266_Config_2.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ESP8266_Config.vdi -applog -m64 -messageDb vivado.pb -mode batch -source ESP8266_Config.tcl -notrace
