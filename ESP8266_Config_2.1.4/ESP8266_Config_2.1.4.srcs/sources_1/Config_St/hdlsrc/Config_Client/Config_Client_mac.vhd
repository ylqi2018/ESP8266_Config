...
ARCHITECTURE rtl OF Config_Client_mac IS
  ...
  SIGNAL is_Config_Client_mac_next        : T_state_type_is_Config_Client_mac;  -- enum type state_type_is_Config_Client_mac (52 enums)
...
BEGIN
  ...
  Config_Client_mac_1_output : PROCESS (is_Config_Client_mac, data_stream_in_ack, rec_cmd_en, model_cmd_unsigned,
    ...
    VARIABLE add_temp_3 : unsigned(4 DOWNTO 0);
  ...
  BEGIN
    ...
    CASE is_Config_Client_mac IS
      ...
      WHEN IN_Tran2_A =>
        IF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_T;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#54#, 8);
          --T
        ELSIF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_A;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#41#, 8);
          --A
          cnt_wait_next <= to_unsigned(16#00000000#, 32);
      ...
      WHEN IN_Tran2_A1 =>
        IF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_P;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#50#, 8);
          --P
        ELSIF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_A1;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#41#, 8);
          --A
        END IF;
      WHEN IN_Tran2_C =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_C;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#43#, 8);
          --C
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_W;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#57#, 8);
          --W
        END IF;
      WHEN IN_Tran2_Comma =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Comma;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#2C#, 8);
          --,
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Quota2;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#22#, 8);
          --"
        END IF;
      WHEN IN_Tran2_D =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_D;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#44#, 8);
          --D
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_R;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#52#, 8);
          --R
        END IF;
      WHEN IN_Tran2_E =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_E;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#45#, 8);
          --E
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Quota1;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#22#, 8);
          --"
        END IF;
      WHEN IN_Tran2_Enter =>
        IF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Enter_1;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#0A#, 8);
          --/n
        ELSIF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Enter;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#0D#, 8);
          --/r
        END IF;
      WHEN IN_Tran2_Enter_1 =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          ...
          --/n
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_send_finish2;
          data_stream_send_stb_reg_next <= '0';
          data_stream_send_reg_next <= to_unsigned(16#00#, 8);
        END IF;
      WHEN IN_Tran2_Equal =>
        IF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Quota;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#22#, 8);
          --"
        ELSIF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Equal;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#3D#, 8);
          --=
        END IF;
      WHEN IN_Tran2_J =>
        IF data_stream_in_ack = '1' THEN 
          ...
          --A
        ELSIF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_J;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#4A#, 8);
          --J
        END IF;
      WHEN IN_Tran2_N =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_N;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#4E#, 8);
          --N
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_T1;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#54#, 8);
          --T
        END IF;
      WHEN IN_Tran2_N1 =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_N1;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#4E#, 8);
          --N
        ELSIF data_stream_in_ack = '1' THEN 
      ...
      WHEN IN_Tran2_O =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_O;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#4F#, 8);
          --O
        ELSIF data_stream_in_ack = '1' THEN 
      ...
      WHEN IN_Tran2_Plus =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Plus;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#2B#, 8);
          --+
        ELSIF data_stream_in_ack = '1' THEN 
      ...
      WHEN IN_Tran2_Quota =>
        IF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_U;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#55#, 8);
          --U
        ELSIF ( NOT data_stream_in_ack) = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Quota;
          data_stream_send_stb_reg_next <= '1';
      ...
      WHEN IN_Tran2_Quota2 =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          ...
          --"
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Quota3;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#22#, 8);
          --"
        END IF;
      WHEN IN_Tran2_Quota3 =>
        IF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Enter;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#0D#, 8);
      ...
      WHEN IN_Tran2_T1 =>
        IF ( NOT data_stream_in_ack) = '1' THEN 
          ...
          --T
        ELSIF data_stream_in_ack = '1' THEN 
          is_Config_Client_mac_next <= IN_Tran2_Underline;
          data_stream_send_stb_reg_next <= '1';
          data_stream_send_reg_next <= to_unsigned(16#5F#, 8);
          --_
        END IF;
      WHEN IN_Tran2_U =>
        IF data_stream_in_ack = '1' THEN 
      ...
      WHEN IN_send_finish =>
        IF rec_cmd_en = '1' THEN 
          ...
          ELSIF model_cmd_unsigned = to_unsigned(16#1#, 4) THEN 
            ...
            add_temp_5 := resize(cnt_wait, 33) + to_unsigned(1, 33);
            IF add_temp_5(32) /= '0' THEN 
              cnt_wait_next <= X"FFFFFFFF";
            ELSE 
              cnt_wait_next <= add_temp_5(31 DOWNTO 0);
            END IF;
            data_stream_send_stb_reg_next <= '0';
            data_stream_send_reg_next <= to_unsigned(16#00#, 8);
          ELSE 
      ...
      WHEN IN_send_finish2 =>
        ...
        ELSIF rec_cmd_en = '1' THEN 
          ...
          ELSIF model_cmd_unsigned = to_unsigned(16#1#, 4) THEN 
            -- receive OK
            is_Config_Client_mac_next <= IN_wait_cnt3;
      ...
      WHEN IN_wait_cnt1 =>
        ...
        ELSIF cnt_wait >= to_unsigned(50000000, 32) THEN 
          ...
          add_temp_3 := resize(model_sel_reg, 5) + to_unsigned(16#01#, 5);
          IF add_temp_3(4) /= '0' THEN 
            model_sel_reg_next <= "1111";
          ELSE 
            model_sel_reg_next <= add_temp_3(3 DOWNTO 0);
          END IF;
          cnt_wait_next <= to_unsigned(16#00000000#, 32);
      ...
      WHEN OTHERS => 
        ...
        ELSIF cnt_wait >= to_unsigned(50000000, 32) THEN 
          --0.05s
          is_Config_Client_mac_next <= IN_device_OK2;
