...
HD_PWD='D:/Vivado_Program_Files/20170711_ESP8266/TEST_END0.1/TEST_END0.1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestEnd.vds -m64 -mode batch -messageDb vivado.pb -notrace -source TestEnd.tcl
