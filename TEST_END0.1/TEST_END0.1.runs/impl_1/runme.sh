...
HD_PWD='D:/Vivado_Program_Files/20170711_ESP8266/TEST_END0.1/TEST_END0.1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestEnd.vdi -applog -m64 -messageDb vivado.pb -mode batch -source TestEnd.tcl -notrace
